...
raw = Raw(store="sample_A+_20160601.zarr/raw", scale_shift=(1 / 255, 0), writable=False)  # type: ignore
affs = Affs(store="sample_A+_20160601.zarr/affs", writable=False)  # type: ignore
